...
ax[0].text(-2, 0.21, '(%.3f)' %(scipy.stats.norm(0,1).ppf(faRate)), ha='center', va='bottom', color='black', fontsize=12 )  
...
ax[1].text(-2, 0.21, '(%.3f)' %(scipy.stats.norm(0,1).ppf(hitRate)), ha='center', va='bottom', color='black', fontsize=12 )  
