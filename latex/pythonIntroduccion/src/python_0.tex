...
\begin{figure}[ht]
        \centering
        \includegraphics[width=10.5cm, height=7cm]{/plot_1.png}
\end{figure}
...
\begin{figure}[ht]
        \centering
        \includegraphics[width=8.5cm, height=7cm]{/seno_coseno.png}
\end{figure}
...
\begin{figure}[ht]
        \centering
        \includegraphics[width=8.5cm, height=7cm]{/2_dimensions.png}
\end{figure}
