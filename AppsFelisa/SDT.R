...
############ ANALISIS PARAMETRICO
      tabItem(tabName = "para",
              ...
              fluidRow(column(width=8, offset = 2, background = 'yellow',
                              ...
                              HTML('<hr style="border: 0; height: 1px; background-image: -webkit-linear-gradient(left, #f0f0f0, #8c8b8b, #f0f0f0); background-image: -moz-linear-gradient(left, #f0f0f0, #8c8b8b, #f0f0f0); background-image: -ms-linear-gradient(left, #f0f0f0, #8c8b8b, #f0f0f0); background-image: -o-linear-gradient(left, #f0f0f0, #8c8b8b, #f0f0f0);"'),
                              HTML('<h4 style="text-align:justify;"></h4>'),
                              HTML('<h4 style="text-align:justify;"> A continuaci&oacuten se ilustra el c&oacutemputo de los par&aacutemetros derivados de la Teor&iacutea de Detecci&oacuten de Se&ntildeales <i>est&aacutendar</i>, donde la variabilidad asociada con la Se&ntildeal y el Ruido es descrita con un par de <b>distribuciones normales con varianzas iguales</b>.</h4>'),
                              HTML('<h4 style="text-align:justify;"> Al realizar una <b>tarea de detecci&oacuten experimental</b>, donde sujetos exprerimentales son expuestos a una serie de ensayos aleatorizados que pueden -o no- contener la se&ntildeal a detectar, las <b>tasas de respuesta</b> (la proporcion de ensayos en que se observa cada tipo de acierto o error), permiten estimar la estructura subyacente a la tarea.</h4>'),
                              HTML('<h4 style="text-align:justify;"> En general, la estimaci&oacuten param&eacutetrica a realizar, encuentra sus bases en las siguientes ideas cetrales:</h4>'),
                              HTML('<h4 style="text-align:justify;"> <b>1.</b> Las tasas de respuesta registradas reflejan el &aacuterea de las distribuciones de Ruido y Se&ntildeal que caen a cada lado del criterio. A partir de ellas es posible estimar 1) la localizaci&oacuten del criterio, 2) la distancia entre las distribuciones y 3) la preferencia o sesgo del sistema hacia una respuesta.</h4>'),
                              HTML('<h4 style="text-align:justify;"> <b>1.1</b> Las tasas de respuesta computadas a partir de un mismo total son complementarias. La tasa de Falsas Alarmas y la tasa de Rechazos correctos suman a 1 porque representan los &uacutenicos resultados posibles al responder a un ensayo con Ruido. Lo mismo ocurre con la tasas de Hits y Omisiones, computadas a partir de los ensayos con la Se&ntildeal. En este tutorial, <b>s&oacutelamente utilizaremos las tasas de Rechazos Correctos y Omisiones</b> para ilustrar la estimaci&oacuten param&eacutetrica, en el entendido de que las tasas de Hits y Falsas Alarmas son redundantes.</h4>'),
                              HTML('<h4 style="text-align:justify;"> <b>2.</b> Para contar con un punto de referencia a partir del cual asignar un valor a los elementos localizados sobre el eje de evidencia (la base de las distribuciones de Ruido y Se&ntildeal), se asigna arbitrariamente una media = 0 a la distribuci&oacuten de Ruido, con una desviaci&oacuten est&aacutendar =  1. Asumiendo que la distribuci&oacuten de Se&ntildeal es equivariante, la localizaci&oacuten de los elementos sobre el eje de evidencia es computada usando <b>como unidad las desviaciones est&aacutendar</b>, (mediante el c&oacutemputo de <b>puntajes Z</b>).</h4>'),
                              HTML('<h4 style="text-align:justify;"> <b>3.</b> La <b>distribuci&oacuten de Ruido siempre tiene que estar a la izquierda</b> de la distribuci&oacuten de Se&ntildeal. La TDS es un modelo de detecci&oacuten, no de discriminaci&oacuten: la evidencia evaluada para emitir un juicio de decisi&oacuten est&aacute intr&iacutensecamente relacionada con la Se&ntildeal y, por fuerza, la Se&ntildeal tiene que contener m&aacutes de esta evidencia que cualquier otro est&iacutemulo.</h4>'),
                              tags$br(),
                              ...
                              HTML('<h4 style="text-align:justify;"> La TDS captura la localizaci&oacuten del criterio sobre el eje de evidencia con el <b>par&aacutemetro k</b>, en unidades de desviaci&oacuten est&aacutendar respecto de la media del Ruido. Para ello, basta computar el <b>puntaje Z</b> correspondiente a la tasa de Rechazos Correctos para localizar el criterio sobre el eje de evidencia.</h4>'),
              ...
              fluidRow(column(width=8, offset = 2, background = 'yellow',
                              ...
                              HTML('<h4 style="text-align:justify;"></h4>'),
                              HTML('<h4 style="text-align:justify;"> La TDS mide la discriminabilidad de la Se&ntildeal y el Ruido con el <b>par&aacutemetro d-prima</b>, que captura <b>la distancia entre las medias de la distribuci&oacuten de Ruido y Se&ntildeal</b>, en unidades de desviaci&oacuten est&aacutendar.</h4>'),
                              HTML('<h4 style="text-align:justify;"> El c&oacutemputo de la d-prima se puede realizar <b>a partir de las tasas de omisiones y rechazos correctos</b>, en tres sencillos pasos:</h4>'),
                              HTML('<h4 style="text-align:justify;"> <b>1.- Estimamos la distancia entre la media del Ruido y el criterio.</b> Usamos la <b>tasa de Rechazos Correctos</b> como indicador del &aacuterea de la distribuci&oacuten de Ruido que ha ca&iacutedo por debajo del criterio. De esta forma, podemos estimar la distancia entre la media de la distribuci&oacuten de ruido y el criterio en unidades de desviaci&oacuten est&aacutendar, computando para ello el puntaje Z correspondiente. El valor absoluto del puntaje Z representa la distancia y el signo (+/-) indica la direcci&oacuten, por debajo (-) o por encima (+) de la media. <b><i>Ver Panel A</i></b>.</h4>'),
                              HTML('<h4 style="text-align:justify;"> <b>2.- Estimamos la distancia entre la media de la distribuci&oacuten Se&ntildeal y el criterio</b> usando la <b>tasa de Omisiones</b> para conocer el &aacuterea de la distribuci&oacute que queda por debajo del criterio y computar el puntaje Z correspondiente. Ahora conoceremos la distancia y posici&oacuten relativa del criterio respecto de la media de la Se&ntildeal. <b><i>Ver Panel B</i></b>.</h4>'),
                              HTML('<h4 style="text-align:justify;"> <b>3.- </b>Finalmente, <b>integramos la informaci&oacuten que tenemos acerca de la distancia entre el criterio y las medias de cada distribuci&oacuten</b> con una resta simple: Restamos el Puntaje Z computado respecto de la distribuci&oacute de Se&ntildeal del Puntaje Z computado a partir de la distribuci&oacuten de Ruido. <b><i>Ver Panel C</i></b>.</h4>'))),
                       ...
                       column(width=5, offset = 1,        
                              ...
                              column(width=10, offset = 1,
                                     ...
                                     tags$br()))),
              fluidRow(column(width=8, offset = 2, background = 'yellow',
                              HTML('<h4 style="text-align:justify;"><b>*</b> N&oacutetese que a pesar de que las tasas de respuesta pueden tener valores reales entre 0 y 1, para efectos de este graficador hemos restringido la tasa de Omisiones entre 0 y 0.5, y la tasa de Rechazos correctos entre 0.5 y 1. Esta restricci&oacuten permite garantizar que durante tu interacci&oacuten con el graficador, la distribuci&oacuten de Se&ntildeal NUNCA estar&aacute por debajo de la distribuci&oacuten de Ruido.</h4>'),
                              tags$br(),
                              HTML('<h2 style="text-align:center; color:purple;"><b>3. Sesgo c</b></h2>'),
                              HTML('<h4 style="text-align:justify;"></h4>'),
                              HTML('<h4 style="text-align:justify;"> Para medir el sesgo del sistema (tanto en t&eacuterminos de su magnitud como direcci&oacuten) la TDS cuenta con el par&aacutemetro <b>C</b>, que captura <b>la distancia entre la localizaci&oacuten del criterio y el punto de sesgo neutro</b>, es decir, el punto en que las distribuciones de Ruido y Se&ntildeal se intersectan y donde en caso de ubicarse el criterio, habr&iacutea la misma probabilidad de cometer cualquier tipo de acierto o error.</h4>'),
                              HTML('<h4 style="text-align:justify;"> Una vez estimados los par&aacutemetros K y d-prima, el c&oacutemputo del par&aacutemetro C puede realizarse a partir de los dos pasos siguientes:</h4>'),
                              HTML('<h4 style="text-align:justify;"> <b>1.- Determinar la localizaci&oacuten del punto neutro.</b></h4>'),
                              HTML('<h4 style="text-align:justify;"> <b>2.- Estimamos la distancia entre el punto neutro y el criterio.</b>Restamos al </h4>'))),
              fluidRow(column(width=10, offset = 1,        
                              column(width=6, offset = 3,        
...
server <- function(input, output) {
  ...
  output$param_discriminabilidad1 <- renderPlot({plot(10, 20, main="", xlab="", ylab="",type='l',
    ...
    text(-2.7,.5,"Tasas de respuesta:",cex=1,col='black',f=2)
    text(-2.6,.47,paste("Rechazo Correcto= ",round(pnorm(qnorm(input$d_rej, 0,1),0,1,lower.tail=TRUE),3)), cex=1, col='dodgerblue3', f=1) 
    text(-2.7,.35,"Distancia entre el criterio", cex=1, col='black', f=2) 
    text(-2.7,.32,"y la media Ruido", cex=1, col='black', f=2)
    text(-2.7,.27,paste("Puntaje Z = ",round(qnorm(input$d_rej, 0,1),3)), cex=1.5, col='black', f=2) 
  ...
  output$param_discriminabilidad2 <- renderPlot({plot(10, 20, main="", xlab="", ylab="",type='l',
    ...
    text(-2.5,.5,"Tasas de respuesta:",cex=1,col='black',f=2)
    text(-2.4,.47,paste("Omisiones= ",round(pnorm(qnorm(input$d_miss, 0,1),0,1,lower.tail=TRUE),3)), cex=1, col='darkorchid3', f=1) 
    text(-2.5,.35,"Distancia entre el criterio", cex=1, col='black', f=2) 
    text(-2.5,.32,"y la media Senal", cex=1, col='black', f=2)
    text(-2.5,.27,paste("Puntaje Z = ",round(qnorm(input$d_miss, 0,1),3)), cex=1.5, col='black', f=2) 
