...
ui <- dashboardPage(
  ...
  dashboardSidebar(
    ...
    sidebarMenu(
      ...
      menuItem("Analisis No Paramétrico", tabName="nop", icon = icon("book")),
  ...
  dashboardBody(
    ...
    tabItems(
      ...
      tabItem(tabName = "about",
              fluidRow(HTML('<h1 style="text-align:center; color:purple;"><b><u>TeorÃÂÃÂÃÂÃÂÃÂÃÂÃÂÂ­a de DetecciÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³n de SeÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ±ales</u></b></h1>'),
                       HTML('<p style="text-align:center;"><b>por Adriana F. ChÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¡vez</b></p>')),
              
              fluidRow(column(width=5, offset = 1, background = 'yellow',
                              HTML('<h1 style="text-align:center; color:purple;"><b>MÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¡s sobre el modelo</b></h1>'),
                              HTML('<hr style="border: 0; height: 1px; background-image: -webkit-linear-gradient(left, #f0f0f0, #8c8b8b, #f0f0f0); background-image: -moz-linear-gradient(left, #f0f0f0, #8c8b8b, #f0f0f0); background-image: -ms-linear-gradient(left, #f0f0f0, #8c8b8b, #f0f0f0); background-image: -o-linear-gradient(left, #f0f0f0, #8c8b8b, #f0f0f0);"'),
                              ...
                              fluidRow(column(width=2, offset=1,
                                       ...
                                       column(width=2,
                                              wellPanel(numericInput(inputId="val_5", 
                                                                     ...
                                                                     value=1, min=0, max=10,
                                                                     width='150px')))),
                              HTML('<h4 style="text-align: justify;">La media funciona como una <b>medida de tendencia central</b> que permite describir en torno a quÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ© valor se distribuyen las observaciones de cierta variable.</h3>')),
      ...
      tabItem(tabName = "roc",
              fluidRow(HTML('<h1 style="text-align:center; color:purple;"><b><u>TeorÃÂÃÂÃÂÃÂÃÂÃÂÃÂÂ­a de DetecciÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³n de SeÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ±ales</u></b></h1>'),
                       HTML('<p style="text-align:center;"><b>por Adriana F. ChÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¡vez</b></p>')),
              HTML('<h4>SecciÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ³n pendiente</h4>')),
