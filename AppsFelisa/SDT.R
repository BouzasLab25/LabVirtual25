    ...
    tabItems(
      ...
      tabItem(tabName = "intro",
              ...
              fluidRow(column(width=5, offset = 1, background = 'yellow',
                              ...
                              HTML('<h4 style="text-align:justify;"> La <b>Teor&iacutea de Detecci&oacuten de Se&ntildeales</b> (<b>TDS</b>), proporciona un modelo estadístico para entender el problema al que se enfrentan los organismos cuando tienen que decidir si <i>algo</i> (una <b>se&ntildeal</b> a detectar) est&aacute o no ocurriendo, para poder guiar su comportamiento en funci&oacuten a las consecuencias anunciadas.</h4>'),
                              HTML('<h4 style="text-align:justify;"> La TDS gira en torno a dos grandes supuestos: <b>1) Siempre hay incertidumbre</b> porque: 1.1 Nuestros sistemas perceptuales son imperfectos, 1.2 Todo est&iacutemulo se presenta y percibe con cierta variabilidad y 1.3 Las sales coexisten en el mundo con <b>ruido</b> (est&iacutemulos que pueden llegar a confundirse con la se&ntilde); y  <b>2) Las consecuencias importan</b>, acertar en el juicio de detecci&oacuten paga, errar cuesta y ambas cosas ocurren con distinta magnitud.</h4>'),
      ...
      tabItem(tabName = "about",
              fluidRow(HTML('<h1 style="text-align:center; color:purple;"><b><u>TeorÃÂÃÂ­a de DetecciÃÂÃÂ³n de SeÃÂÃÂ±ales</u></b></h1>'),
                       HTML('<p style="text-align:center;"><b>por Adriana F. ChÃÂÃÂ¡vez</b></p>'),
                       tags$br(),
                       tags$br()),
              HTML('<h1 style="text-align:center;"><b>SecciÃÂÃÂ³n pendiente</b></h1>')),
